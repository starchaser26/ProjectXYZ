...
powershell.exe -nologo -noprofile -command "& { Add-Type -A 'System.IO.Compression.FileSystem'; [IO.Compression.ZipFile]::ExtractToDirectory('%pXYZ_ROOT%\libsrc\URHO3D-1.6\foo.zip', '%pXYZ_ROOT%\libsrc\URHO3D-1.6'); }"
